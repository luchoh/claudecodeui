...
// SEC-007: Update check functionality removed per user mandate
// No calls to npm registry or external services
...
async function main() {
    ...
    switch (command) {
        ...
        case '--version':
            showVersion();
            break;
        // SEC-007: 'update' command removed per user mandate
        default:
